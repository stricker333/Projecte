package alumnes.Modulos.GestioAlumnes.GestioAO.Modelo.pager;
...
//Import Main para objeto singleton
//import alumnes.Ventanas.Main;
...
public class pagina {
    ...
    public static void inicializa() {
        ...
        rowCount = ((OnlineSimpleTableModel) Vent1.tablaOnline.getModel()).getRowCount();
        ...
        Vent1.jPanel3.setLayout(new BorderLayout());
        Vent1.jPanel3.add(pagina.box);

    }

    public static void initLinkBox() {

        ControladorVent1.sorter.setRowFilter(new RowFilter<TableModel, Integer>() {
        ...
        if ((rowCount <= itemsPerPage) && (rowCount > 0)) { //caben todos los datos en la misma página
            ...
            Vent1.primero.setEnabled(false);
            Vent1.ANTERIOR.setEnabled(false);
            Vent1.SIGUIENTE.setEnabled(false);
            Vent1.ultimo.setEnabled(false);
            Vent1.CAJA.setText("");
            ...
            Vent1.primero.setEnabled(currentPageIndex > 1);
            Vent1.ANTERIOR.setEnabled(currentPageIndex > 1);
            Vent1.SIGUIENTE.setEnabled(currentPageIndex < maxPageIndex);
            Vent1.ultimo.setEnabled(currentPageIndex < maxPageIndex);
            Vent1.CAJA.setText(Integer.toString(currentPageIndex) + String.format(" / %d", maxPageIndex));
